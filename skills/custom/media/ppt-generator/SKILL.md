...
- Skill 模式：`.Codex/skills/ppt-generator/slides_plan.json`
...
**这是 Skill 的核心优势**：我（Codex）会分析生成的 PPT 图片，为每个转场生成精准的视频提示词。
...
3. **Codex Skill 标准位置** - `~/.Codex/skills/ppt-generator/.env`
4. **系统环境变量** - 如果以上都未找到
