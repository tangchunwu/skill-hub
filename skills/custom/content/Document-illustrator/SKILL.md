...
根据你指定的数量，Codex 会智能归纳文档，然后展示给你确认：
...
Codex: 好的，16:9 竖屏，不生成封面，8 张内容配图。
        [将文档归纳为 8 个主题]
        [展示归纳结果，用户确认后生成]
```
...
**API 密钥**：
- 在 `~/.Codex/skills/document-illustrator/.env` 中配置
...
如有问题或建议：
1. 直接在 Codex 中询问 Codex
2. 查看计划文件：`~/.Codex/plans/shimmering-tickling-seahorse.md`
3. 检查 Skill 目录：`~/.Codex/skills/document-illustrator/`
