---
name: Codex-api
description: Anthropic Codex API patterns for Python and TypeScript. Covers Messages API, streaming, tool use, vision, extended thinking, batches, prompt caching, and Codex Agent SDK. Use when building applications with the Codex API or Anthropic SDKs.
origin: ECC
---

# Codex API

Build applications with the Anthropic Codex API and SDKs.

## When to Activate

- Building applications that call the Codex API
- Code imports `anthropic` (Python) or `@anthropic-ai/sdk` (TypeScript)
- User asks about Codex API patterns, tool use, streaming, or vision
- Implementing agent workflows with Codex Agent SDK
...
| Model | ID | Best For |
|-------|-----|----------|
| Opus 4.1 | `Codex-opus-4-1` | Complex reasoning, architecture, research |
| Sonnet 4 | `Codex-sonnet-4-0` | Balanced coding, most development tasks |
| Haiku 3.5 | `Codex-3-5-haiku-latest` | Fast responses, high-volume, cost-sensitive |
...
Define tools and let Codex call them:
...
export ANTHROPIC_MODEL="Codex-sonnet-4-0"
```
