...
description: 'CC-Panes bundled skill: 启动任务'
---

# 启动任务

在 CC-Panes 管理的项目中启动新的 Claude/Codex 实例。
...
若未指定项目：
1. 调用 `ccpanes.list_projects` 获取项目列表
2. 展示列表供用户选择
...
可选：调用 `ccpanes.get_task_status` 确认启动成功。
